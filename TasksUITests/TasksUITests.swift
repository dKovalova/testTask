 ...
 class LoginScreen: BaseTestCase {
    ...
    override func tearDownWithError() throws {
     ...
     func testSuccessfulLogin() throws {
         ...
         let loggingin = app.staticTexts["Logging in..."]
         let checklistpoint = app.staticTexts["Buy milk"]
        ...
        self.checkElementExists(elements: [checklistpoint, logout, toolbar], timeout: 1)
